 ...
 * @author rbanevicius
 */
public class PMe_EC_TestCommand extends Command {
	...
	public function execute(params:UnpureTestVo):void {
		trace("PMe_EC_TestCommand execute :", getMessageType(), params);

		AssertExpress.equals(params, UnpureTestConst.PMe_EC, "Mvce command got wrong data.");
		AssertExpress.equals(getMessageType(), UnpureTestMessageTypes.PMe_EC_TEST, "Mvce command got wrong type.");
