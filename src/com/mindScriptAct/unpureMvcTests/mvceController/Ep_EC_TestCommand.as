 ...
 * @author rbanevicius
 */
public class EP_EC_TestCommand extends Command {
	...
	public function execute(params:UnpureTestVo):void {
		trace("EP_EC_TestCommand execute :", getMessageType(), params);

		AssertExpress.equals(params, UnpureTestConst.EP_EC, "Mvce command got wrong data.");
		AssertExpress.equals(getMessageType(), UnpureTestMessageTypes.EP_EC_TEST, "Mvce command got wrong type.");
