 ...
 * @author rbanevicius
 */
public class EC_EC_TestCommand extends Command {
	...
	public function execute(params:UnpureTestVo):void {
		trace("EC_EC_TestCommand execute :", getMessageType(), params);

		var test:Object = UnpureTestConst.EC_EC;

		AssertExpress.equals(params, UnpureTestConst.EC_EC, "Mvce command got wrong data.");
		AssertExpress.equals(getMessageType(), UnpureTestMessageTypes.EC_EC_TEST, "Mvce command got wrong type.");
