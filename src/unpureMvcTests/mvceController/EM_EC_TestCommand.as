 ...
 * @author rbanevicius
 */
public class EM_EC_TestCommand extends Command {
	...
	public function execute(params:UnpureTestVo):void {
		trace("EM_EC_TestCommand execute :", getMessageType(), params);

		AssertExpress.equals(params, UnpureTestConst.EM_EC, "Mvce command got wrong data.");
		AssertExpress.equals(getMessageType(), UnpureTestMessageTypes.EM_EC_TEST, "Mvce command got wrong type.");
