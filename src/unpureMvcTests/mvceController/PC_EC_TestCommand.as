 ...
 * @author rbanevicius
 */
public class PC_EC_TestCommand extends Command {
	...
	public function execute(params:UnpureTestVo):void {
		trace("PC_EC_TestCommand execute :", getMessageType(), params);

		AssertExpress.equals(params, UnpureTestConst.PC_EC, "Mvce command got wrong data.");
		AssertExpress.equals(getMessageType(), UnpureTestMessageTypes.PC_EC_TEST, "Mvce command got wrong type.");
