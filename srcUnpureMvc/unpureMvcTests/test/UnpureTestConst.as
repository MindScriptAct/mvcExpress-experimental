package unpureMvcTests.test {
public class UnpureTestConst {

	private static var _TESTCOUNTER:int = 0;


	public static const EC_EC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const EC_EM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const EC_PC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const EC_PM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);

	public static const EP_EC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const EP_EM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	...
	public static const PP_PC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const PP_PM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);

	public static const PM_EC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	...
	public static const F_EM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const F_PC:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
	public static const F_PM:UnpureTestVo = new UnpureTestVo(_TESTCOUNTER++);
